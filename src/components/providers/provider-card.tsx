    ...
    >
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm font-light text-foreground truncate">
            {provider.name}
          </CardTitle>
          <span
        ...
        {provider.channelName && (
          <span className="inline-block w-fit rounded-full bg-secondary/60 px-2.5 py-0.5 text-xs text-muted-foreground">
            {provider.channelName}
          </span>
        )}
      </CardHeader>
